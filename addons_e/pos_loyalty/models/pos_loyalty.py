...
class LoyaltyProgram(models.Model):
    ...
    points = fields.Float(string='Point per $ spent', help="How many loyalty points are given to the customer by sold currency", digits='Loyalty Currency')
...
class LoyaltyRule(models.Model):
    ...
    points_currency = fields.Float(string="Points per $ spent", digits='Loyalty Currency')
