...
tagged('post_install', '-at_install', 'bank_holidays')
class TestBankHolidays(AccountTestInvoicingCommon):
    ...
    def test_bank_holidays(self):
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('NET'), 1888.99, places=2)


@tagged('post_install', '-at_install', 'public_holiday_compensation')
class TestPublicHolidayCompensation(AccountTestInvoicingCommon):
...
@tagged('post_install', '-at_install', 'bank_holiday_half_days')
class TestBankHolidayHalfDays(AccountTestInvoicingCommon):
    ...
    def test_bank_holiday_half_days(self):
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P'), -214.26, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR.2'), -141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.INT.2'), -5.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.MOB.2'), -4.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('M.ONSS'), -23.66, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('NET'), 2149.58, places=2)
