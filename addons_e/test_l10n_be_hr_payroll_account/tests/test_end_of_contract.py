...
class TestEndOfContract(AccountTestInvoicingCommon):
    ...
    def test_end_of_contract(self):
        ...
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('OUT'), 856.15, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('BASIC'), 1793.85, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('SALARY'), 1802.85, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ONSS'), -235.63, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('EmpBonus.1'), 166.25, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR'), 141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('GROSS'), 1874.6, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P'), -246.36, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P.DED'), 55.09, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('NET'), 1667.94, places=2)
...
class TestOutOfContractCreditTime(AccountTestInvoicingCommon):
    ...
    def test_out_of_contract_credit_time(self):
        ...
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('WORK100'), 774.62, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('OUT'), 1345.38, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('BASIC'), 774.62, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.INT'), 5.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.MOB'), 4.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('SALARY'), 783.62, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ONSS'), -102.42, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('EmpBonus.1'), 102.42, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR'), 141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('GROSSIP'), 924.76, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP.PART'), -193.65, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('GROSS'), 731.1, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P'), 0.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P.DED'), 0.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR.2'), -141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.INT.2'), -5.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.MOB.2'), -4.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('M.ONSS'), 0.0, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('REP.FEES'), 150.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP'), 193.65, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP.DED'), -12.6, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('NET'), 903.29, places=2)
...
class TestOutOfContractPublicHoliday(AccountTestInvoicingCommon):
    ...
    def test_out_of_contract_public_holiday(self):
        ...
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('OUT'), 1345.38, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('LEAVE500'), 122.31, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_amount('WORK100'), 1182.31, places=2)

        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_days('OUT'), 11.0, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_days('LEAVE500'), 1.0, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_days('WORK100'), 11.0, places=2)

        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_hours('OUT'), 83.6, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_hours('LEAVE500'), 7.6, places=2)
        self.assertAlmostEqual(self.payslip._get_worked_days_line_number_of_hours('WORK100'), 83.6, places=2)

        self.assertAlmostEqual(self.payslip._get_salary_line_total('BASIC'), 1304.62, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.INT'), 5.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.MOB'), 4.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('SALARY'), 1313.62, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ONSS'), -171.69, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('EmpBonus.1'), 171.69, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR'), 141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('GROSSIP'), 1454.76, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP.PART'), -326.15, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('GROSS'), 1128.6, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P'), -9.89, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('P.P.DED'), 9.89, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.CAR.2'), -141.14, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.INT.2'), -5.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('ATN.MOB.2'), -4.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('M.ONSS'), 0.0, places=2)
        ...
        self.assertAlmostEqual(self.payslip._get_salary_line_total('REP.FEES'), 150.0, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP'), 326.15, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('IP.DED'), -21.24, places=2)
        self.assertAlmostEqual(self.payslip._get_salary_line_total('NET'), 1421.38, places=2)
